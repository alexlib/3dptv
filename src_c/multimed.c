...
void multimed_nlay_v2(Exterior ex, Exterior ex_o, mm_np mm, double X, double Y,
                      double Z, double *Xq, double *Yq) {
  // Beat Lüthi, Nov 2007 comment actually only Xq is affected since all Y and
  // Yq are always zero
  int i, it = 0;
  double beta1, beta2[32], beta3, r, rbeta, rdiff, rq, mmf;
  ...
  // Beat Lüthi, Nov 2007, I will implement the Risö method to avoid all this
  // sin, atan etc
...
void trans_Cam_Point_back(Exterior ex, mm_np mm, Glass gl, double X, double Y,
  ...
  //--Beat Lüthi June 07: I change the stuff to a system perpendicular to the
  //interface
  double dummy;
  double nGl;
