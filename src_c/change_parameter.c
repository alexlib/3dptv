...
int parameter_panel_init(Tcl_Interp *interp) {
  ...
  fp1 = fopen_rp(
      "parameters/pft_version.par"); // replaced fopen_r, ad holten 12-2012
  if (!fp1)
    return TCL_OK;
  ...
  fp1 =
      fopen_rp("parameters/cal_ori.par"); // replaced fopen_r, ad holten 12-2012
  if (!fp1)
    return TCL_OK;
  ...
  fp1 = fopen_rp(
      "parameters/detect_plate.par"); // replaced fopen_r, ad holten 12-2012
  if (!fp1)
    return TCL_OK;
  ...
  fp1 =
      fopen_rp("parameters/man_ori.par"); // replaced fopen_r, ad holten 12-2012
  if (!fp1)
    return TCL_OK;
  ...
  fp1 =
      fopen_rp("parameters/shaking.par"); // replaced fopen_r, ad holten 12-2012
  if (!fp1)
    return TCL_OK;
  ...
  fp1 =
      fopen_rp("parameters/orient.par"); // replaced fopen_r, ad holten 12-2012
  if (!fp1)
    return TCL_OK;
