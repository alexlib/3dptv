...
// ----------------------------------------- To prevent compiler warnings, void*
// are used in the argument list of a function for declaring multidimensional
// arrays.
...
void matmul_v2(double *a, void *b, double *c, int m, int n, int k, int m_large,
               int n_large) {
  int i, j, l;
  double x, *pa, *pb, *pc;
