...
void det_lsq(Ex, I, ap, mm, x1, y1, x2, y2, x3, y3, x4, y4, Xp, Yp,
             Zp) Exterior Ex[4];
Interior I[4];
ap_52 ap[4];
mm_np mm;
...
void det_lsq_3(Ex, I, ap, mm, x1, y1, x2, y2, x3, y3, Xp, Yp,
               Zp) Exterior Ex[3];
Interior I[3];
ap_52 ap[3];
mm_np mm;
double x1, y1, x2, y2, x3, y3, *Xp, *Yp, *Zp;
{
  ...
  /* approximate values (rt_is with the uncorrected image coordinates) */
  ray_tracing(x1, y1, Ex[0], I[0], mm, &X1, &Y1, &Z1, &a1, &b1, &c1);
  ray_tracing(x2, y2, Ex[1], I[1], mm, &X2, &Y2, &Z2, &a2, &b2, &c2);
  intersect_rt(X1, Y1, Z1, a1, b1, c1, X2, Y2, Z2, a2, b2, c2, Xp, Yp, Zp);
...
void det_lsq_4(Ex, I, ap, mm, x1, y1, x2, y2, x3, y3, x4, y4, Xp, Yp,
               Zp) Exterior Ex[4];
Interior I[4];
ap_52 ap[4];
mm_np mm;
...
void det_lsq_2(Ex, I, ap, mm, x1, y1, x2, y2, Xp, Yp, Zp) Exterior Ex[2];
Interior I[2];
ap_52 ap[2];
mm_np mm;
