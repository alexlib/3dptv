...
void ray_tracing(double x, double y, Exterior Ex, Interior I, mm_np mm,
                 double *Xb2, double *Yb2, double *Zb2, double *a3, double *b3,
                 double *c3)

/* ray-tracing, see HOEHLE and Manual of Photogrammetry */
{
  double a1, b1, c1, a2, b2, c2, Xb1, Yb1, Zb1, d1, d2, cosi1, cosi2, vect1[3],
      vect2[3], factor, s2;
...
void point_line_line(Exterior Ex0, Interior I0, Glass G0, mm_np mm, double gX0,
                     double gY0, double gZ0, double a0, double b0, double c0,
                     Exterior Ex1, Interior I1, Glass G1, double gX1,
                     double gY1, double gZ1, double a1, double b1, double c1,
                     double *x, double *y, double *z)
// Beat Lüthi Nov 2008
{
  double a[3], b[3], A[3], B[3], n[3], AB[3], dist, Bp[3], c, ABp[3], mABp, d,
      Ae1[3], e1[3], mb, nb[3], cosb, f, Ap[3], App[3], BpAe1[3], mBpAe1;
  double dummy;
  ...
  dummy = sqrt(pow(App[0] - Ap[0], 2) + pow(App[1] - Ap[1], 2) +
               pow(App[2] - Ap[2], 2));
...
void ray_tracing_v2(double x, double y, Exterior Ex, Interior I, Glass G,
                    mm_np mm, double *Xb2, double *Yb2, double *Zb2, double *a3,
                    double *b3, double *c3)
/* ray-tracing, see HOEHLE and Manual of Photogrammetry */
{
  double a1, b1, c1, a2, b2, c2, Xb1, Yb1, Zb1, d1, d2, vect1[3], vect2[3], s2;
  ...
  //...	from Jakob Mann vector3 XLinePlane(vector3 a, vector3 b, struct plane
  //pl)
